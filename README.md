...
First download PHP libraries required:
...
Remember to register before signing in; if you want to make other user-based requests you'll need to run
the "Login and remember token" request prior to making a set of other requests (remember this especially if
you shut down Postman and re-open it again).
...
NB: the auto-generated data may not match specific names/accounts in the tickets. This is not essential to solving any
of the issues.
